...
class FastTrain:
    ...
    def train(self, data, learning_rate, max_epochs=500, log_fn=default_log_fn):
        ...
        for epoch in range(max_epochs):
            ...
            total_time += end_time - start_time  # Duration of the epoch
            # Logging
            if epoch % 10 == 0 or epoch == max_epochs:
                ...
                average_time_per_epoch = total_time / 10
                print(f"A single epoch completed on average in {average_time_per_epoch:.2f} seconds")
                total_time = 0.0
